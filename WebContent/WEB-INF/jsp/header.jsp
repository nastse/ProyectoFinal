				 	...
				 	<div id="contenedor-icono" class="col-12 justify-content-center">
						<div class="row justify-content-around ">
							<div class="col-2 p-0 text-center">
								<a id="icono" href="${pageContext.request.contextPath}/index"><i class="fa fa-home"></i></a>
							</div>
							<div class="col-2 p-0 text-center">	
								<a id="icono" href="${pageContext.request.contextPath}/login"><i class="fa fa-user-circle"></i></a>
							</div>
							<div class="col-2 p-0 text-center">		
								<a id="icono" href="${pageContext.request.contextPath}/login"><i class="fa fa-plus-circle"></i></a>	
							</div>
						</div>
					</div>
...
<%-- 						<button id="boton" type="reset" class="btn btn-light btn-sm btn-block" onclick="location.href='${pageContext.request.contextPath}/index';">INICIO</button> --%>
							<a href="${pageContext.request.contextPath}/index"><i class="fa fa-arrow-circle-up"></i></a>
...
<%-- 						<button id="boton" type="reset" class="btn btn-light btn-sm btn-block" onclick="location.href='${pageContext.request.contextPath}/login';">LOGIN</button> --%>
							<a href="${pageContext.request.contextPath}/login"><i class="fa fa-user-circle"></i></a>
...
<%-- 						<button id="boton" type="reset" class="btn btn-light btn-sm btn-block" onclick="location.href='${pageContext.request.contextPath}/signup';">ALTA NUEVA</button> --%>
							...
							<a href="${pageContext.request.contextPath}/login"><i class="fa fa-plus-circle"></i></a>	
					</div>
			</div>
		</c:if>
			...
			<div id="banner" class="row p-1 d-flex justify-content-end align-items-center">			
					<div id="contenedor-icono" class="col-12 justify-content-center">
						<div class="row justify-content-around ">
							...
							<div class="col-2 p-0 text-center">	
								<a href="${pageContext.request.contextPath}/myproducts"><i class="fa fa-plus-circle"></i></a>
							</div>
							<div class="col-2 p-0 text-center">		
								<a href="${pageContext.request.contextPath}/logout"<c:url value='/logout'/>"><i class="fa fa-power-off"></i></a>	
							</div>
							<div class="col-2 p-0 text-center">		
								<c:if test="${not empty sessionScope.datos[0].imagen}">
									<a href="${pageContext.request.contextPath}/myprofile"><img class="rounded-circle rounded justify-content-center shadow m-1" width="35px" height="35px" src="https://s3.us-east-2.amazonaws.com/nastse-s3/imagenes/${datos[0].imagen}"></a>
								</c:if>
								<c:if test="${empty sessionScope.datos[0].imagen}">
									<a href="${pageContext.request.contextPath}/myprofile"><img class="rounded-circle rounded justify-content-center shadow m-1" width="35px" height="35px" src="https://s3.us-east-2.amazonaws.com/nastse-s3/imagenes/imagen.png"></a>
								</c:if>
							</div>
						</div>
					</div>
...
<%-- 						<button id="boton" type="reset" class="btn btn-success btn-sm btn-block" onclick="location.href='${pageContext.request.contextPath}/myproducts';">MIS REVIEWS</button>	 --%>
					...
					<div id="usuario-subir" class="col-4 p-1 text-right">
						...
						<a href="${pageContext.request.contextPath}/logout"><i class="fa fa-power-off"></i></a>		
